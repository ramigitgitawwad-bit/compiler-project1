...
public class TemplateParser extends Parser {
	...
	public static final int
		...
		JINJA_STMT_START=6, JINJA_COMMENT=7, HTML_TAG_CLOSE_START=8, HTML_TAG_OPEN=9, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"JINJA_STMT_START", "JINJA_COMMENT", "HTML_TAG_CLOSE_START", "HTML_TAG_OPEN", 
	...
	public final TemplateContext template() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 66152L) != 0)) {
				{
				{
				setState(28);
				element();
	...
	public static class HtmlTextContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TemplateParserVisitor ) return ((TemplateParserVisitor<? extends T>)visitor).visitHtmlText(this);
			else return visitor.visitChildren(this);
		}
	}
